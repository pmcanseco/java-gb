...
public class MMU {
	...
	static byte[] bios = hexStringToByteArray(
	...
	public static byte rb(int addr) {
		...
		case 0x8000:
		case 0x9000:
			return 0;//GPU.vram[addr & 0x1FFF]; // TODO
	...
	public static void wb(int addr, byte val) {
		...
		case 0xF000:
			...
			case 0xF00:
				if((addr & 0xFF) > 0xFF7F) 
					...
					switch(addr & 0xF0) {
						// I have no idea why this is here, but he might populate it later so I'm keeping it.
						// TODO remove if unused by the end.
					}
			}
			break;
		}
	...
	public static void ww(int addr, short val) {
		/* Write 16-bit word to a given address */
		wb(addr, (byte) (val&255)); // mask to 8 bits.
		wb(addr+1, (byte) (val>>8)); // write remaining 8 bits.
	}
